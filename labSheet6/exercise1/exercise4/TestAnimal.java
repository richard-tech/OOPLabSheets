package labSheet6.exercise1.exercise4;
...
public class TestAnimal {
    public static void main( String args[]) {
        ...
        System.out.println("\nCalling the 4-argument constructor to create a Anaconda Snake object....");
        Animal animal5  = new Animal("Anaconda Snake",new String[]{"Asia","America"},100,8);
